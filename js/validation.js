...
function checkInputs() {
  ...
  if (usernameValue === "") {
    //show error
    //add error class
    setErrorFor(username, " Oops! Preencha os campos solicitados.");
  ...
  if (emailValue === "") {
    setErrorFor(email, " Oops! Preencha os campos solicitados.");
  ...
  if (passwordValue === "") {
    setErrorFor(password, " Oops! Preencha os campos solicitados.");
  ...
  if (password2Value === "") {
    setErrorFor(password2, " Oops! Preencha os campos solicitados.");
